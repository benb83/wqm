    ...
    .factory('ribbon', ['$rootScope', function($rootScope) {
        var ribbon = {
            ...
            updateBreadcrumb: function(crumbs) {
                crumbs.push('Home');
                // crumbs.push('<i class="fa fa-home"></i>');
...
angular.module("ui.ladda", []).directive("uiLadda", ["$timeout", function(e) {
    return {
        link: function(t, r, o) {
            var n = Ladda.create(r[0]);
            t.$watch(o.uiLadda, function(t) {
                angular.isNumber(t) ? t >= 0 && 1 > t ? n.isLoading() ? n.setProgress(t) : (n.start(), e(function() {
                    n.setProgress(t)
                }, 300)) : n.isLoading() && n.stop() : t ? n.isLoading() || n.start() : n.isLoading() && n.stop()
            }, !0)
        }
    }
}]);